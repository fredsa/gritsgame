...
ClientChainGunClass = ChainGunClass.extend({
  ...
  onDraw: function (owningPlayer) {
   ...
   var attachPts = {
	...
	drawSprite("chaingun.png", attachPts.x0, attachPts.y0, {noMapTrans:true});
    gRenderEngine.context.scale(1, -1);
...
Factory.nameClassMap['ChainGun'] = ClientChainGunClass;
