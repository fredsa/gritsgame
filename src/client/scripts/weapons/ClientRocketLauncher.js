...
ClientRocketLauncherClass = RocketLauncherClass.extend({
  ...
  onDraw: function (owningPlayer) {
	...
	drawSprite("rocket_launcher.png", attachPts.x0, attachPts.y0, {noMapTrans:true});
    gRenderEngine.context.scale(1, -1);
	
	/*
    spt = owningPlayer.spriteSheet.getStats("gun10");
...
Factory.nameClassMap['RocketLauncher'] = ClientRocketLauncherClass;
