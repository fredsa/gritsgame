...
ClientThrustersClass = ThrustersClass.extend({
  ...
  onDraw: function (owningPlayer) {
	...
	var spt = sheet.getStats('thruster.png');
	...
	drawSprite("thruster.png", attachPts.x0, attachPts.y0, {ctx:ctx,noMapTrans:true});
  },
});

Factory.nameClassMap['Thrusters'] = ClientThrustersClass;
