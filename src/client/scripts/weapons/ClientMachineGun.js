...
ClientMachineGunClass = MachineGunClass.extend({
  ...
  onDraw: function (owningPlayer) {
	...
	drawSprite("machinegun.png", attachPts.x0, attachPts.y0, {noMapTrans:true});
	gRenderEngine.context.scale(1, -1);
...
Factory.nameClassMap['MachineGun'] = ClientMachineGunClass;
